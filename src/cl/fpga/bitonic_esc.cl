...
__kernel void bitonic_esc(__global const uint* restrict indices,
                          uint group_start,
                          uint group_length,

                          __global
                          const uint* restrict pre_matrix_rows_pointers, // указатели, куда записывать, или преф сумма по nnz_estimation
                          __global uint* restrict pre_matrix_cols_indices, // указатели сюда, записываем сюда
