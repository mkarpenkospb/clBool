...
__kernel void hash_symbolic_global(__global const unsigned int *indices, // indices -- aka premutation
    ...
    __global uint *hash_table = hash_table_data + max_nnz * row_id_bin;
