...
void testMatrixAddition() {
    ...
    matrix_coo_cpu matrix_a_cpu = coo_utils::generate_random_matrix_coo_cpu(475726, 10756);
    matrix_coo_cpu matrix_b_cpu = coo_utils::generate_random_matrix_coo_cpu(667312, 3526);
